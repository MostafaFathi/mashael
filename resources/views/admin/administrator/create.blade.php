    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h4 class="card-title">{{__('Add administrator')}}</h4>

                <h6 class="card-subtitle"> {{__('Add administrators description')}} </h6>

                <div class="panel-body">

                    <form class="form-horizontal" method="POST" action="{{ route('admin::administrator.store') }}">
