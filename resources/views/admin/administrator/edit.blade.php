    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h4 class="card-title">{{__('Edit administrators')}}</h4>

                <h6 class="card-subtitle"> {{__('Edit administrators description')}} </h6>

                <div class="panel-body">

                    <form class="form-horizontal" method="POST" action="{{ route('admin::administrator.update',$administrator->id) }}">
                        ...
                        <div class="form-group{{ $errors->has('firstname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="firstname" type="text" class="form-control" name="firstname" value="{{$administrator->firstname}}" required>
                        ...
                        <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="lastname" type="text" class="form-control" name="lastname" value="{{$administrator->lastname}}" required>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="email" type="email" class="form-control" name="email" value="{{ $administrator->email }}" required>
                        ...
                        <div class="form-group{{ $errors->has('notes') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="notes" type="text" class="form-control" name="notes">{{$administrator->notes}}</textarea>
                            ...
                            <div class="col-md-12 col-md-offset-4">
                                ...
                                <div class="checkbox">
                                    ...
                                    <label>
                                        ...
                                        <input type="checkbox" name="status" {{ $administrator->status == "Active" ? 'checked="checked"' : '' }}> {{__('Status')}}
