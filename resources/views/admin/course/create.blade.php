        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle"> {{__('Add course description')}} </h6>

                    <div class="panel-body">

                        <form class="form-horizontal" method="POST" action="{{ route('admin::course.store') }}"
                            ...
                            <div class="form-group{{ $errors->has('persons') ? ' has-error' : '' }}">
                                ...
                                <label for="persons" class="col-md-4 control-label">{{__('Persons')}} <span class="badge badge-danger">{{__('0 is unlimited')}}</label>
                            ...
                            <div class="form-group{{ $errors->has('date_time_to') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input id="date_time_to" type="text" class="form-control datetimepicker" name="date_time_to"
                                           value="{{old('date_time_to')}}" placeholder="{{date("Y-m-d")}}" required>
