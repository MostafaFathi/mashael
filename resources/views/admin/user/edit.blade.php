                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('admin::user.update',$user->id) }}">
                        ...
                        <div class="form-group{{ $errors->has('notes') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="notes" type="text" class="form-control" name="notes">{{$user->notes}}</textarea>
                            ...
                            <div class="col-md-12 col-md-offset-4">
                                ...
                                <div class="checkbox">
                                    ...
                                    <label>
                                        ...
                                        <input type="checkbox" name="status" {{ $user->status == "Active" ? 'checked="checked"' : '' }}> {{__('Status')}}
