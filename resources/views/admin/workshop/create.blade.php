        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h4 class="card-title">{{__('Add workshop')}}</h4>

                    <h6 class="card-subtitle"> {{__('Add workshop description')}} </h6>

                    <div class="panel-body">

                        <form class="form-horizontal" method="POST" action="{{ route('admin::workshop.store') }}"
                            ...
                            <div class="form-group{{ $errors->has('slider') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="custom-control custom-checkbox mr-sm-2">
                                        <input type="checkbox" class="custom-control-input" id="slider" name="slider" value="1">
                                        <label class="custom-control-label" for="slider">{{__('Show on slider')}}</label>
                                    </div>
                            ...
                            <div class="form-group{{ $errors->has('intro') ? ' has-error' : '' }}">
                                ...
                                <label for="intro" class="col-md-4 control-label">{{__('Intro name')}}</label>
                            ...
                            <div class="form-group{{ $errors->has('intro_image') ? ' has-error' : '' }}">
                                ...
                                <label for="intro_image" class="col-md-4 control-label">{{__('Intro name')}}</label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select id="category_id" type="file" class="form-control" name="category_id[]"
                                        ...
                                        @foreach(\App\Category::get() as $cat)
                                            ...
                                            <option value="{{$cat->id}}"
                                            @if(old('category_id'))
                                                {{in_array($cat->id,old('category_id')) ? "selected" : ""}}
                                                @endif
                                            >{{$cat->name}}
                                            </option>
                            ...
                            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <label for="price" class="col-md-4 control-label">{{__('The price for one person')}}</label>
                            ...
                            <div class="form-group{{ $errors->has('price2') ? ' has-error' : '' }}">
                                ...
                                <label for="price2" class="col-md-4 control-label">{{__('Price for more than one person')}}</label>
                            ...
                            <div class="form-group{{ $errors->has('persons') ? ' has-error' : '' }}">
                                ...
                                <label for="persons" class="col-md-4 control-label">{{__('Persons')}} <span class="badge badge-danger">{{__('0 is unlimited')}}</span></label>
                            ...
                            <div class="form-group{{ $errors->has('date_time_to') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input id="date_time_to" type="text" class="form-control datetimepicker" name="date_time_to"
                                           value="{{old('date_time_to')}}" placeholder="{{date("Y-m-d H:i:s")}}" required>
                            ...
                            <div class="form-group{{ $errors->has('register_status') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="custom-control custom-checkbox mr-sm-2">
                                        <input type="checkbox" class="custom-control-input" id="register_status" name="register_status" value="1">
                                        <label class="custom-control-label" for="register_status">{{__('Disabled register')}}</label>
                                    </div>
