    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-info d-lg-block m-l-15 pull-right" href="{{route('admin::trainer.create')}}"> <i class="fa fa-plus-circle"></i> {{__('Add new')}}</a>

                <h4 class="card-title">{{__('Trainers')}}</h4>

                <h6 class="card-subtitle"> {{__('Trainers description')}} </h6>
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-hover" >
        					...
        					@if( $trainers )
                                ...
                                <tr>
                                    ...
                                    <td>{!! $trainer->status == "Active" ? '<span class="m-badge m-badge--success m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-success">'.__('Active').'</span>' : '<span class="m-badge m-badge--danger m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-danger">'.__('Inactive').'</span>' !!}</td>

                                    <td style="width: 180px;">

                                        <a href="{{ route('admin::trainer.edit' , $trainer->id ) }}" class="btn btn-xs btn-info" title="Edit details"><i class="fa fa-edit"></i> {{__('Edit')}}</a>

                                        <form action="{{ route('admin::trainer.destroy' ,$trainer->id ) }}" method="post" class="Delete" style="display: inline-block;" >
                        ...
                        {{ $trainers->appends(request()->input())->links() }}
