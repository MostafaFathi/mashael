            ...
            <div class="breadcrumb-center d-table">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">نتائج البحث: {{request('search')}}</li>
                    </ol>
                </nav>
    ...
    <section class="page-courses">
        ...
        <div class="container">
            ...
            <div class="all-courses">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @if(!auth()->check() or !in_array($course->id,auth()->user()->courses->pluck('id')->toArray()))
                                        <a class="btn" href="{{route('site::course',$course->id)}}">الإشتراك بورشة العمل</a>
                                    @else
                ...
                <hr>
                <h3>نتائج البحث في ورش العمل</h3>
